        ...
        <div className="py-10 bg-blue-900">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div>
                        <div className="flex flex-col justify-center space-y-2 items-center text-white">
                            <ImHappy className="text-[60px] font-bold"/>
                            <h2 className="font-bold[2">3500</h2>
                    ...
                    <div>
                        <div className="flex flex-col justify-center space-y-2 items-center text-white">
                            ...
                            <h2 className="font-bold[2">460+</h2>
                    ...
                    <div>
                        <div className="flex flex-col justify-center space-y-2 items-center text-white">
                            ...
                            <h2 className="font-bold[2">40+</h2>
                    ...
                    <div>
                        <div className="flex flex-col justify-center space-y-2 items-center text-white">
                            ...
                            <h2 className="font-bold[2">440+</h2>
