    ...
    return(
        <div className="py-10 bg-slate-100">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center">
                    <div className="flex gap-9">
                        ...
                        <div className="">
                            ...
                            <div>
                                <h2>Service Time</h2>
                                <h4 className="font-bold">Online Service:  <span className="font-bold text-[18px] bg-blue-800 px-2 rounded-lg text-white">{online_service_time}</span> </h4>
                                <h4 className="font-bold">Offline Service: <span className="font-bold text-[18px] bg-blue-800 px-2 rounded-lg text-white">{offline_service_time}</span> </h4>
                            </div>
                        </div>
                    </div>
                    <div>
                ...
                <div className="flex my-6 bg-block py-2 gap-16">
                    <div>
